...
function get21thRecipe(){
  document.querySelector(".twentyone-meal-detail").style.display = "block"
}
function get22thRecipe(){
  document.querySelector(".twentytwo-meal-detail").style.display = "block"
}
function get23thRecipe(){
  document.querySelector(".twentythree-meal-detail").style.display = "block"
}
function get24thRecipe(){
  document.querySelector(".twentyfour-meal-detail").style.display = "block"
}
function get25thRecipe(){
  document.querySelector(".twentyfive-meal-detail").style.display = "block"
}
...
function closeBtn(){
  ...
  document.querySelector(".twentyone-meal-detail").style.display ="none"
  document.querySelector(".twentytwo-meal-detail").style.display ="none"
  document.querySelector(".twentythree-meal-detail").style.display ="none"
  document.querySelector(".twentyfour-meal-detail").style.display ="none"
  document.querySelector(".twentyfive-meal-detail").style.display ="none"
